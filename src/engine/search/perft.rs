...
impl Position {
    pub fn perft<const ROOT: bool>(&self, depth: u8) -> u64 {
        self.perft_internal::<ROOT>(depth, &mut RepetitionTable::new())
    }

    fn perft_internal<const ROOT: bool>(&self, depth: u8, rep_table: &mut RepetitionTable) -> u64 {
